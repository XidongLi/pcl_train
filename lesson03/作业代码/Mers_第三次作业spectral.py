...
def Spectral_Clustering_Graph (data,k):
...
def Unnormalized_Spectral_Clustering(W,k,datas):
...
Unnormalized_Spectral_Clustering(W,2,noisy_circles)

W=Spectral_Clustering_Graph (noisy_moons,10)
Unnormalized_Spectral_Clustering(W,2,noisy_moons)

W=Spectral_Clustering_Graph (blobs,10)
Unnormalized_Spectral_Clustering(W,3,blobs)

W=Spectral_Clustering_Graph (no_structure,10)
Unnormalized_Spectral_Clustering(W,3,no_structure)

W=Spectral_Clustering_Graph (aniso,10)
Unnormalized_Spectral_Clustering(W,3,aniso)

W=Spectral_Clustering_Graph (varied,10)
Unnormalized_Spectral_Clustering(W,3,varied)
